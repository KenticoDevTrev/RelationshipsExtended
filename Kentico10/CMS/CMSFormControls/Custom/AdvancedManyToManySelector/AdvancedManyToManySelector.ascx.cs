...
public partial class CMSFormControls_Custom_AdvancedManyToManySelector_AdvancedManyToManySelector : FormEngineUserControl
{
    /// <summary>
    ...
    #region "Variables"
    private FieldSaveType RelatedObjectSaveMode;
    #endregion
    ...
    {
        if (UIContext.Current != null && UIContext.Current.ResourceName == "CMS.Form")
        {
        ...
        {
            case "id":
                RelatedObjectSaveMode = FieldSaveType.ID;
                break;
            case "guid":
                RelatedObjectSaveMode = FieldSaveType.GUID;
                break;
            case "string":
                RelatedObjectSaveMode = FieldSaveType.String;
                break;
        }
    ...
    private List<string> GetCurrentObjects()
    {
        ...
        try
        {
            var CurrentObjectsDS = ConnectionHelper.ExecuteQuery(JoinTableName + ".selectall", null, string.Format("{0} = '{1}'", JoinTableLeftFieldName, Form.GetDataValue(JoinTableThisObjectForeignKey)), null, -1, null, -1, -1, ref totalRecords);
...
enum FieldSaveType { ID, GUID, String };
