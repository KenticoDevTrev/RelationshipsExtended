<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/CMSModules/RelationshipsExtended/Controls/RelatedCategories.ascx.cs" Inherits="CMSModules_RelationshipExtended_Controls_RelatedPage_Tree" %>
<style>
.ContentTree {
  padding-top: 20px;
  padding-bottom: 20px;
