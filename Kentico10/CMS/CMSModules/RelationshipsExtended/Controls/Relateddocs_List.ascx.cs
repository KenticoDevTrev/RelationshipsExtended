...
public partial class CMSModules_RelationshipExtended_Controls_Relateddocs_List : CMSAbstractUIWebpart
{
    #region "Properties"
    ...
    public int CurrentNodeID
    {
        get
        {
            return ValidationHelper.GetInteger(GetValue("CurrentNodeID"), -1);
        } set
        {
