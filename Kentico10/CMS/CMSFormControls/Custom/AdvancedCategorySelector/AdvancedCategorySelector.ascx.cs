...
public partial class CMSModules_Custom_Category_AdvancedCategorySelector : FormEngineUserControl
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        ScriptHelper.RegisterScriptFile(this.Page, ResolveUrl("~/CMSGlobalFiles/CMSFormControls/Custom/AdvancedCategorySelector/js/jquery.js"));
        ScriptHelper.RegisterScriptFile(this.Page, ResolveUrl("~/CMSGlobalFiles/CMSFormControls/Custom/AdvancedCategorySelector/js/AdvancedCategorySelector.js"));
        Literal cssFile = new Literal() { Text = @"<link href=""" + ResolveUrl("~/CMSGlobalFiles/CMSFormControls/Custom/AdvancedCategorySelector/css/styles.css") + @""" type=""text/css"" rel=""stylesheet"" />" };
    ...
    protected void setCategoryTree()
    {
        ...
        else if (SaveModeVal == SaveType.ToJoinTable)
        {
            ...
            if (!IsPostBack)
            {
                ...
                int totalRecords = 0;
                var currentCategoriesDS = ConnectionHelper.ExecuteQuery(JoinTableName + ".selectall", null, string.Format("{0} = '{1}'", JoinTableLeftFieldName, Form.GetDataValue(JoinTableThisObjectForeignKey)), null, -1, null, -1, -1, ref totalRecords);
    ...
    protected object CurrentItemIdentification
    {
        get
        {
            return Form.GetDataValue(JoinTableThisObjectForeignKey);
        }
    }
