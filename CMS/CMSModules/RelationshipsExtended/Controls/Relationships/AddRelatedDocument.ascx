<%@ Control Language="C#" AutoEventWireup="true"  Inherits="Compiled_CMSModules_RelationshipsExtended_Controls_Relationships_AddRelatedDocument" %>
<%@ Register Src="~/CMSModules/RelationshipsExtended/FormControls/Relationships/selectRelationshipNames.ascx" TagName="RelationshipNameSelector" TagPrefix="cms" %>
