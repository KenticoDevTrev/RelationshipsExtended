...
public partial class CMSModules_RelationshipExtended_Controls_UIControls_NodeBindingEditItem : CMSAbstractUIWebpart
{
    #region "Variables"
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        if (NodeID > 0)
        {
            UIContext.EditedObject = new DocumentQuery().TopN(1).WhereEquals("NodeID", NodeID).FirstObject;
        }
        // CUSTOMIZATION END
