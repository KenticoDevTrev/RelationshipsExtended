...
public partial class Compiled_CMSModules_RelationshipsExtended_Controls_EditMenu : EditMenu, IExtensibleEditMenu
{
    #region "Variables"
    ...
    /// Constructor
    /// </summary>
    public Compiled_CMSModules_RelationshipsExtended_Controls_EditMenu()
    {
        ShowSave = true;
        ShowCheckOut = true;
        ShowCheckIn = true;
