...
public partial class CMSModules_RelationshipExtended_Controls_RelatedPage_Tree : CMSAbstractWebPart
{
    ...
    private CMS.DocumentEngine.TreeNode PageDocument
    {
        get
        {
            return (DocumentContext.CurrentDocument != null ? DocumentContext.CurrentDocument : new DocumentQuery().WhereEquals("NodeID", QueryHelper.GetInteger("NodeID", 0)).Culture(QueryHelper.GetString("culture", "en-US")).CombineWithDefaultCulture(true).FirstObject);
        }
    }
